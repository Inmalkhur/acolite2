...
Панель: откройте `http://127.0.0.1:3000/` (на Bothost порт из `PORT`, обычно 3000). Секрет по умолчанию — `change-me` (`LOCAL_SYNC_SECRET`). Без него GUI покажет «нет доступа» и пустые чаты.
